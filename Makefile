...
am__objects_1 = remote-stub.$(OBJEXT)
#am__objects_1 = remote-cstms.$(OBJEXT)
...
make_DEPENDENCIES =   $(am__DEPENDENCIES_1) \
...
ACLOCAL = ${SHELL} /build/aosp/external/make/config/missing aclocal-1.14
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AM_LDFLAGS = -Wl,--export-dynamic
AR = ar
AUTOCONF = ${SHELL} /build/aosp/external/make/config/missing autoconf
AUTOHEADER = ${SHELL} /build/aosp/external/make/config/missing autoheader
AUTOMAKE = ${SHELL} /build/aosp/external/make/config/missing automake-1.14
AWK = gawk
CC = /android/bin/mygcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPP = /android/bin/mygcc -E
CPPFLAGS = 
CYGPATH_W = echo
...
LTLIBINTL = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /build/aosp/external/make/config/missing makeinfo
...
PACKAGE_STRING = GNU make 4.1.90
...
abs_builddir = /build/aosp/external/make
abs_srcdir = /build/aosp/external/make
abs_top_builddir = /build/aosp/external/make
abs_top_srcdir = /build/aosp/external/make
ac_ct_AR = 
ac_ct_CC = /android/bin/mygcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /build/aosp/external/make/config/install-sh
...
include ./$(DEPDIR)/guile.Po
include ./$(DEPDIR)/hash.Po
include ./$(DEPDIR)/implicit.Po
include ./$(DEPDIR)/job.Po
include ./$(DEPDIR)/load.Po
include ./$(DEPDIR)/loadapi.Po
include ./$(DEPDIR)/loadavg-getloadavg.Po
include ./$(DEPDIR)/main.Po
include ./$(DEPDIR)/misc.Po
include ./$(DEPDIR)/output.Po
include ./$(DEPDIR)/read.Po
include ./$(DEPDIR)/remake.Po
include ./$(DEPDIR)/remote-cstms.Po
include ./$(DEPDIR)/remote-stub.Po
include ./$(DEPDIR)/rule.Po
include ./$(DEPDIR)/signame.Po
include ./$(DEPDIR)/strcache.Po
...
loadavg-getloadavg.o: getloadavg.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(loadavg_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT loadavg-getloadavg.o -MD -MP -MF $(DEPDIR)/loadavg-getloadavg.Tpo -c -o loadavg-getloadavg.o `test -f 'getloadavg.c' || echo '$(srcdir)/'`getloadavg.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/loadavg-getloadavg.Tpo $(DEPDIR)/loadavg-getloadavg.Po
#	$(AM_V_CC)source='getloadavg.c' object='loadavg-getloadavg.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(loadavg_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o loadavg-getloadavg.o `test -f 'getloadavg.c' || echo '$(srcdir)/'`getloadavg.c

loadavg-getloadavg.obj: getloadavg.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(loadavg_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT loadavg-getloadavg.obj -MD -MP -MF $(DEPDIR)/loadavg-getloadavg.Tpo -c -o loadavg-getloadavg.obj `if test -f 'getloadavg.c'; then $(CYGPATH_W) 'getloadavg.c'; else $(CYGPATH_W) '$(srcdir)/getloadavg.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/loadavg-getloadavg.Tpo $(DEPDIR)/loadavg-getloadavg.Po
#	$(AM_V_CC)source='getloadavg.c' object='loadavg-getloadavg.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(loadavg_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o loadavg-getloadavg.obj `if test -f 'getloadavg.c'; then $(CYGPATH_W) 'getloadavg.c'; else $(CYGPATH_W) '$(srcdir)/getloadavg.c'; fi`
